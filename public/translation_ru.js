window.t = (eng) => {
    const translations = {
        ...
        'Wait for players to write their hints': 'Подождите, пока игроки напишут мины',
        'Write your hint': 'Напишите мину!',
        'Wait for players to delete duplicates': 'Загадайте слово не наступая на мины',
        'Delete duplicates': 'Следите, что б никто не наступил на мины',
